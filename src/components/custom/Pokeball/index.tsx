...
const PokeBall = (props: PokeBallProps) => {
  ...
  let className = 'pokeball';
  if (animated) className = `${className} animated`;

  return <div className='pokeball-container f fd-col'>
    <svg  version="1.1" id="Pokéball" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
      ...
      xmlSpace="preserve">
       <ellipse className='pokeball-surface' cx="297.65" cy="519.85" rx="297.65" ry="74.25" />
      <g id="Pokéball_1_" className={className}>
        <g id="Colours">
